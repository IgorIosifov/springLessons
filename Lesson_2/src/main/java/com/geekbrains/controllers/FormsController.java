...
public class FormsController {
    ...
    public String modProcessForm(@RequestParam("productTitle") String productTitle, Model model) {
        productTitle = "Modified: " + productTitle;
        model.addAttribute("studentName", productTitle);
